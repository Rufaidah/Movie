...
//        String Trailertype = getActivity().getIntent().getStringExtra("type");
        ...
        Picasso.with(getContext()).load(latar).placeholder(R.drawable.icon).into(imgMovie);
    ...
    private void SubRequestData(String i){
        ...
        String url = "";
        url = "http://api.themoviedb.org/3/movie/" + i + "/videos?api_key=426ba8a9574c2c4d837f613ea78e87a4";
